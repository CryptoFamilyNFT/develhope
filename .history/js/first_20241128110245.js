...
let day = prompt("Per che giorno?").toString().toLowerCase();
let price;
let discount_perc;
let dayPrice;
...
alert("Il prezzo del biglietto è " + price + "€" + "sconto del: " + discount_perc + "%");
alert("Lo sconto applicato è del " + discount_perc + "%");
