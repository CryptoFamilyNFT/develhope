...
function App() {
  const langHelper = new LanguageHelper();
  ...
  function switchText(lang) {
    saveContext({...context, lang});
    return langHelper.switchText(lang);
  }
  ...
  return (
    ...
    <Users/>*/}
      ...
      <input type="checkbox" checked={langSelected === 'en'} value={'en'} onChange={(e) => switchText(e.event.target)} />
      <input type="checkbox" checked={langSelected === 'fr'} value={'fr'} onChange={(e) => switchText(e.event.target)} />
      <input type="checkbox" checked={langSelected === 'es'} value={'es'} onChange={(e) => switchText(e.event.target)} />
    </div>
  );
}
